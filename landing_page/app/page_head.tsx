...
export default function Home() {
  ...
  const projects: Project[] = [
    ...
    {
      title: "Bandit CLI",
      dates: "Jun 2026 ΓÇô Present (Beta)",
          ...
          <div className="w-full md:w-[48%] flex-1 md:flex-none flex flex-col justify-center px-margin-mobile md:px-0 md:pl-[calc(max(40px,(100vw-1280px)/2))] md:pr-12 relative z-10 pb-12 md:pb-0">
            <div className="flex flex-col gap-6 w-full max-w-[500px]">
              ...
              <p className="font-body-md text-body-md text-[#D9D3C7]/90 max-w-md md:border-l-2 border-primary md:pl-4 relative z-10 text-center md:text-left mx-auto md:mx-0 border-l-0 pl-0 text-[14px] sm:text-[16px]">
                ...
                distributed systems ΓÇö <span className="whitespace-nowrap">I build</span> what holds
                everything together.
              </p>
                  ...
                  <div className="flex-1 p-6 sm:p-8 flex flex-col gap-5 justify-between min-w-0">
                    ...
                    <div>
                      ...
                      <div className="flex gap-4 border-t border-outline/30 pt-4">
                        ...
                        >
                          SOURCE_CODE <span className="text-xs">ΓåÆ</span>
                        </a>
                        {project.liveUrl && (
                          <a
                          ...
                          >
                            DEMO_LINK <span className="text-xs">ΓåÆ</span>
                          </a>
                        )}
                      </div>
                    </div>
                        ...
                        <div className="mt-4 pt-4 border-t border-outline/20 animate-fadeIn space-y-4">
                          ...
                          <ul className="font-body-md text-on-surface text-[14.5px] md:text-[15.5px] space-y-3 leading-relaxed font-normal">
                            <li className="flex items-start gap-3">
                              <span className="font-mono-code text-primary font-bold mt-0.5 text-base">ΓÇ║</span>
                              <span>
                                Architected a microservices backend with <strong className="font-bold text-on-surface border-b border-outline/40">8ΓÇô10 Node.js/Express services</strong>, each operating on an isolated PostgreSQL database instance.
                              </span>
                            </li>
                            <li className="flex items-start gap-3">
                              <span className="font-mono-code text-primary font-bold mt-0.5 text-base">ΓÇ║</span>
                            ...
                            <li className="flex items-start gap-3">
                              <span className="font-mono-code text-primary font-bold mt-0.5 text-base">ΓÇ║</span>
                              <span>
                                Eliminated N+1 query bottlenecks on job browsing endpoints using <strong className="font-bold text-on-surface border-b border-outline/40">Redis caching</strong>, sustaining throughput of <strong className="font-bold text-on-surface">400ΓÇô600 RPS</strong> under load tests with Autocannon.
                              </span>
                            </li>
                          </ul>
                        ...
                        <div className="mt-4 pt-4 border-t border-outline/20 animate-fadeIn space-y-4">
                          ...
                          <div className="pt-2 flex justify-end">
                            ...
                            >
                              ...
                              VIEW VERIFIED CREDENTIAL <span className="text-xs">ΓåÆ</span>
                            </a>
                          </div>
                        </div>
                      )}
